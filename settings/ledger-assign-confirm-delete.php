...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    //if(count($data)==0){
        $query_delete_ledger="DELETE FROM tbl_voucher_ledger_assoc WHERE ledgerid='$ledgerId' AND subvoucherid='$voucherId'";
        ...
        {
            mysqli_rollback($dbh);
            $msg="Assigned records could not be deleted";
        }
        else
        {
            $msg="Assigned records deleted";
            mysqli_commit($dbh);
        }
    /* }
    else{
  ...
  <body id="body-pd" class="body-pd">
    ...
    <main class="container-fluid pt-4">
      ...
      <div class="card-mid">
          ...
          <form method="POST">
            <p>Are you sure want to delete the assigned records?</p>
    ...
    <script>
      ...
      function backToMaster(){
        window.location.href='ledger-assign.php';
      }
    </script>
