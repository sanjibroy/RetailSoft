...
$query_get_data    =   "SELECT DATE_FORMAT(m.vchdate,'%d-%m-%Y'),m.partycode,p.partyname,v.primaryvchtype,m.vchno,ABS(m.amount) FROM tbl_transactionmaster m INNER JOIN tbl_vouchertype v ON v.slno=m.subvoucherid INNER JOIN tbl_partymaster p ON m.partycode=p.partycode WHERE v.primaryvchtype in ('Purchase','Sale','Payment','Receipt') AND m.vchdate BETWEEN '$fromDate' AND '$toDate' ORDER BY m.slno desc";
...
<body id="body-pd" class="body-pd">
                        ...
                        <tbody id="display-indent-list" style="cursor:pointer">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <?php if($data[$i][3]=="Purchase" || $data[$i][3]=="purchase" || $data[$i][3]=="Payment"){?>
                                        
                                        <td align="right"><?php $drTotal+=$data[$i][5]; echo $data[$i][5]; ?></td>
                                        <td></td>
                                    <?php }else{?>
                                        <td></td>
                                        <td align="right"><?php $crTotal+=$data[$i][5]; echo $data[$i][5]; ?></td>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td align="right"><b><?php echo $drTotal;?></b></td>
                                    <td align="right"><b><?php echo $crTotal;?></b></td>
                                </tr>
                                <?php $balance=$drTotal-$crTotal;?>
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    ...
                                    <?php if($crTotal>$drTotal){?>
                                        <td align="right"><b><?php echo abs($balance);?></b></td>
                                        <td></td>
                                    <?php }else{?>
                                        <td></td>
                                        <td align="right"><b><?php echo abs($balance);?></b></td>
    ...
    <script>
        ...
        function editPurchase(id){
            ...
            //let url =   `../vouchers/edit-purchase.php?id=${id}`;
