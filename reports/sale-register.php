...
<body id="body-pd" class="body-pd">
    ...
    <main class="container-fluid pt-4">
        <div class="card" id="dashboard">
            ...
            <div class="card-top">
                <div class="heading">Sale Register</div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="f-control flex-column align-items-start">
                                ...
                                <input type="date" id="from-date" name="from-date" value="<?php echo $today;?>">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="f-control flex-column align-items-start">
                                <label>To Date</label>
                                <input type="date" id="to-date" name="to-date" value="<?php echo $today;?>">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="f-control flex-column align-items-start">
                ...
                <div class="table-responsive" style="max-height: 70vh; overflow-y: auto;">
                    <table class="table">
                        ...
                        <tbody id="display-indent-list" style="cursor:pointer">
                            ...
                            ?>
                                <tr>
                                    <td onclick="editSales('<?php echo $data[$i][4]; ?>')"><?php echo $i+1; ?></td>
                                    <td onclick="editSales('<?php echo $data[$i][4]; ?>')"><?php echo $data[$i][0]; ?></td>
                                    <td onclick="editSales('<?php echo $data[$i][4]; ?>')"><?php echo $data[$i][2]; ?></td>
                                    <td onclick="editSales('<?php echo $data[$i][4]; ?>')"><?php echo $data[$i][4]; ?></td>
                                    <td onclick="editSales('<?php echo $data[$i][4]; ?>')"><?php echo $data[$i][5]; ?></td>
                                    <td><button onclick="deleteSale('<?php echo $data[$i][4];?>')" class="btn-r"><i class="bx bxs-trash"></i></button></td>
                                </tr>
                            <?php
                                }
                            ?>
    ...
    <script>
        ...
        function editSales(id){
            ...
            let url =   `../vouchers/edit-sales.php?id=${id}`;
