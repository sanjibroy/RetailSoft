...
<body id="body-pd" class="body-pd">
    ...
    <main class="container-fluid pt-4">
        <div class="card" id="dashboard">
            ...
            <div class="card-top">
                <div class="heading">Purchase Register</div>
            </div>
                        ...
                        <tbody id="display-indent-list" style="cursor:pointer">
                            ...
                            ?>
                                <tr >
                                    ...
                                    <td><button onclick="deletePurchase('<?php echo $data[$i][4];?>')" class="btn-r"><i class="bx bxs-trash"></i></button></td>
                                </tr>
                            <?php
                                }
                            ?>
