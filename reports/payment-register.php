...
<body id="body-pd" class="body-pd">
    ...
    <main class="container-fluid pt-4">
        <div class="card" id="dashboard">
            ...
            <div class="card-top d-flex align-item-center">
                <div class="heading">Payment Register</div>
            </div>
                        ...
                        <tbody id="display-indent-list" style="cursor:pointer">
                            ...
                            ?>
                                <tr >
                                    ...
                                    <td><button onclick="deletePayment('<?php echo $data[$i][4];?>')" class="btn-r"><i class="bx bxs-trash"></i></button></td>
                                </tr>
                            <?php
                                }
                            ?>
    ...
    <script>
        ...
        function editPurchase(id){
            ...
            let url =   `../vouchers/edit-payment.php?id=${id}`;
