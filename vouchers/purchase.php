...
<head>
    ...
    <title><?php echo $PURCHASE_TITLE; ?></title>
...
<body id="body-pd" class="body-pd">
    ...
    <main class="container-fluid pt-4">
        <div class="card" id="dashboard">
            ...
            <option>Category Wise</option>
                ...
                <div class="heading">Manage Purchase</div>
            </div>
            <div class="card-mid">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="f-control flex-column align-items-start">
                            <label>Date</label>
                            <input type="date" name="vchdate" id="vchdate" value="<?php echo date('Y-m-d');?>">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="f-control flex-column align-items-start">
                    ...
                    <div class="col-md-3">
                        <div class="f-control flex-column align-items-start">
                            ...
                            <input type="text" id="supplier" placeholder="Select Supplier">
                    ...
                    <div class="col-md-2">
                        <div class="f-control flex-column align-items-start">
                            ...
                            <input type="text" id="supplierinvno" placeholder="Invoice No">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="f-control flex-column align-items-start">
                            <label>Invoice Date</label>
                            <input type="date" id="supplierinvdate" placeholder="Invoice Date">
                        </div>
                    </div>
            ...
            <div class="card-bot">
                <div class="d-flex w-100">
                    <button class="btn my-2" onclick="callSave()">Create Purchase</button>
                </div>
            </div>
    ...
    function getPartyBalance(partycode){
